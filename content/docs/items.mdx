...
<Callout>
Custom provider items are resolved through Strata's item hooks. Strata **0.6.2+**
...
plugin is missing, the id is wrong, or Strata is older than 0.6.2), the voucher
