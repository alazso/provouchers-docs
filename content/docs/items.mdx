...
<Callout>
Custom provider items are resolved through Strata's item hooks. Strata **0.10.0+**
...
plugin is missing, the id is wrong, or Strata is older than 0.10.0), the voucher
