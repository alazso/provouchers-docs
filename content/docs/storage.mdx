...
[Strata](https://github.com/alazso/strata)'s pooled storage. The backend is chosen
...
The JDBC driver and connection pool are provided by Strata; you do not install or
shade anything yourself.
...
Cooldowns are currently held in memory and reset on restart; they are not written
to the database yet. See the [FAQ](/docs/faq) for the implications.
